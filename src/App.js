...
const API_URL = 'https://fame8-backend-1.onrender.com/api';
...
export default function App() {
  ...
  // Check for existing token on mount OR token from Google OAuth
  useEffect(() => {
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <button 
                onClick={() => window.location.href = 'https://fame8-backend-1.onrender.com/api/auth/google'}
                className="w-full py-3 rounded-xl bg-white text-gray-800 font-semibold flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors"
              >
